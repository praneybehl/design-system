...
import Chrome from '../src/ui/layout/chrome'
import { Heading, Link, P } from '../src/ui/common'

export default props =>
  <Chrome title="Welcome">
    Jake
  </Chrome>
...
const Header = props =>
  <header className="header">
    <Heading size="xxLarge" className="title">
      <h1>
        <Title css={props.css} />
      </h1>
    </Heading>
    <style jsx>{`
      .header {
        background: linear-gradient(to bottom, #2bb2e3, #137bc2);
        height: 200px;
        display: flex;
...
const Home = props =>
  <Chrome fullWidthContent={<Header />}>
    <Point title="Purpose">
    ...
    <Action href="https://www.sketchapp.com/">
