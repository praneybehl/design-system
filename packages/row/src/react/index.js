...
const FullOverlayLink = glamorous.span({
  pointerEvents: 'all'
})
...
RowComponent.propTypes = {
  actionBar: PropTypes.arrayOf(RowComponent.Action),
  actionBarVisible: PropTypes.bool,
  fullOverlay: RowComponent.FullOverlayLink,
  fullOverlayVisible: PropTypes.bool,
  image: PropTypes.oneOfType([RowComponent.Image, RowComponent.ImageLink]),
  metadata1: PropTypes.arrayOf(
    PropTypes.oneOfType([PropTypes.string, RowComponent.TextLink])
  ),
  metadata2: PropTypes.arrayOf(
    PropTypes.oneOfType([PropTypes.string, RowComponent.TextLink])
  ),
  progress: PropTypes.number,
  title: PropTypes.oneOfType([RowComponent.TextLink, PropTypes.string])
    .isRequired,
